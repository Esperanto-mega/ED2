...
# =====================================================
# Task 12 -- User2Preference -- 8 Prompt
# =====================================================
...
# =====================================================
# Task 11 -- Preference2User -- 8 Prompt
# =====================================================
...
# =====================================================
# Task 10 -- Possible User Prediction -- 10 Prompt
# =====================================================
...
#####——1
prompt = {}
prompt["instruction"] = "I find the user {user}'s historical interactive items: {inters}, and I want to know what next item the user needs. Can you help me decide?"
prompt["response"] = "{item}"
seqrec_prompt.append(prompt)
...
#####——16
prompt = {}
prompt["instruction"] = "You have obtained the ordered list of user {user} historical interaction items, which is as follows: {inters}. Using this history as a reference, please select the next item to recommend to the user."
prompt["response"] = "{item}"
seqrec_prompt.append(prompt)
...
#####——0
prompt = {}
prompt["instruction"] = "The user {user} has sequentially interacted with items {inters}. Can you recommend the next item for him? Tell me the title of the item？"
prompt["response"] = "{title}"
...
#####——11
prompt = {}
prompt["instruction"] = "You have obtained the ordered title list of user {user} historical interaction items, as follows: {inter_titles}. Based on this historical context, kindly choose the subsequent item for user recommendation."
prompt["response"] = "{item}"
fusionseqrec_prompt.append(prompt)
...
#####——0
prompt = {}
prompt["instruction"] = "Here is the historical interactions of a user {user}: {inters}. And his personalized preferences are as follows: \"{explicit_preference}\". Your task is to recommend an item that is consistent with the user's preference."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)

#####——1
prompt = {}
prompt["instruction"] = "The user {user} has interacted with a list of items, which are as follows: {inters}. Based on these interacted items, the user current intent is as follows \"{user_related_intention}\", and your task is to generate an item that matches the user's current intent."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)

#####——2
prompt = {}
prompt["instruction"] = "As a recommender system, you are assisting a user {user} who has recently interacted with the following items: {inters}. The user expresses a desire to obtain another item with the following characteristics: \"{item_related_intention}\". Please recommend an item that meets these criteria."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)

#####——3
prompt = {}
prompt["instruction"] = "Using the user {user}'s current query: \"{query}\" and his historical interactions: {inters}, you can estimate the user's preferences \"{explicit_preference}\". Please respond to the user's query by selecting an item that best matches his preference and query."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)

#####——4
prompt = {}
prompt["instruction"] = "The user {user} needs a new item and searches for: \"{query}\". In addition, he has previously interacted with: {inters}. You can obtain his preference by analyzing his historical interactions: \"{explicit_preference}\". Can you recommend an item that best matches the search query and preferences?"
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)

#####——5
prompt = {}
prompt["instruction"] = "Based on the user {user}'s historical interactions with the following items: {inters}. You can infer his preference by observing the historical interactions: \"{explicit_preference}\". Now the user wants a new item and searches for: \"{query}\". Please select a suitable item that matches his preference and search intent."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
#####——9
prompt = {}
prompt["instruction"] = "You meet a user {user}'s query: \"{query}\". Please respond to this user by selecting an appropriate item."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
#####——10
prompt = {}
prompt["instruction"] = "Your task is to recommend the best item that matches the user {user}'s query. Here is the search query of the user: \"{query}\", tell me the item you recommend."
prompt["response"] = "{item}"
itemsearch_prompt.append(prompt)
...
#####——0
prompt = {}
prompt["instruction"] = "The user {user} has interacted with items {inters} in chronological order. Please estimate his preferences."
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——1
prompt = {}
prompt["instruction"] = "Based on the items that the user {user} has interacted with: {inters}, can you infer what preferences he has?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——3
prompt = {}
prompt["instruction"] = "Can you provide a summary of the user {user}'s preferences based on his historical interactions: {inters}?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——4
prompt = {}
prompt["instruction"] = "After interacting with items {inters} in order, what preferences do you think the user {user} has?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——5
prompt = {}
prompt["instruction"] = "Here is the item interaction history of the user: {inters}, could you please infer the user {user}'s preferences."
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——6
prompt = {}
prompt["instruction"] = "Based on the user {user}'s historical interaction records: {inters}, what are your speculations about his preferences?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——7
prompt = {}
prompt["instruction"] = "Given the user {user}'s historical interactive items arranged in chronological order: {inters}, what can be inferred about the preferences of the user?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——8
prompt = {}
prompt["instruction"] = "Can you speculate on the user {user}'s preferences based on his historical item interaction records: {inters}?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——9
prompt = {}
prompt["instruction"] = "What is the preferences of a user {user} who has previously interacted with items {inters} sequentially?"
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——10
prompt = {}
prompt["instruction"] = "Using the user {user}'s historical interactions as input data, summarize the user's preferences. The historical interactions are provided as follows: {inters}."
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)

#####——11
prompt = {}
prompt["instruction"] = "Utilizing the ordered list of the user {user}'s historical interaction items as a reference, please make an informed estimation of the user's preferences. The historical interactions are as follows: {inters}."
prompt["response"] = "{explicit_preference}"
preferenceobtain_prompt.append(prompt)
